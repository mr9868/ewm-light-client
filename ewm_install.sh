...
wget -O ipfs-latest.tar.gz https://dist.ipfs.tech/kubo/v0.$ipfsv.0/kubo_v0.$ipfsv.0_linux-amd64.tar.gz && tar -xvzf kubo-latest.tar.gz && sudo bash kubo/install.sh 
